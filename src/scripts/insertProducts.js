...
const product = [
        ...
        "reviews": [
            {
                "user": "Ravi",
                "rating": 5,
                "comment": "Amazing detail and quality. Worth the price!",
                "images": [
                    "product1.png"
                ]
            },
            {
                "user": "Aditi",
                "rating": 4,
                "comment": "Loved the finish and packaging was great.",
                "images": [
                    "product1.png",
                    "product1.png"
                ]
            },
            {
                "user": "Karan",
                "rating": 5,
                "comment": "A must-have for any Godzilla fan!",
                "images": []
            }
        ],
        "features": [
            {
                "icon": "Category",
                "text": "Made with high-quality PLA for a durable and smooth finish."
            },
            {
                "icon": "Power",
                "text": "Powered using a universal Type-C connector for easy plug-and-play."
            },
            {
                "icon": "Bluetooth",
                "text": "Seamlessly controlled via Bluetooth for a wireless experience."
            },
            {
                "icon": "PhoneIphone",
                "text": "Fully compatible with both iOS and Android devices."
            }
        ],
        "services": [
    ...
    },
    {
        ...
        "reviews": [
            {
                "user": "Sana",
                "rating": 5,
                "comment": "The glow effect is superb. Looks amazing at night!",
                "images": [
                    "product2.png"
                ]
            },
        ...
        "features": [
            ...
            {
                "icon": "LightMode",
                "text": "Built-in glow lighting system with easy control."
            },
            {
                "icon": "Power",
                "text": "Powered via universal Type-C connector."
            },
            {
                "icon": "Bluetooth",
                "text": "Wireless control with Bluetooth."
            }
        ],
        "services": [
            "UPI / Debit / Credit Cards Accepted",
        ...
        "reviews": [
            {
                "user": "Manoj",
                "rating": 5,
                "comment": "Absolutely stunning piece. Neon pop looks sick.",
                "images": [
                    "product3.png"
                ]
            },
            {
                "user": "Priya",
                "rating": 4,
                "comment": "Loved it. Just wish stock comes back soon.",
                "images": []
            }
        ],
        "features": [
            ...
            {
                "icon": "LightMode",
                "text": "Vibrant neon finish enhances display aesthetics."
            },
            {
                "icon": "Power",
                "text": "Type-C powered lighting system."
            },
            {
                "icon": "Bluetooth",
                "text": "Wireless control via Bluetooth."
            }
        ],
        "services": [
            "UPI / Debit / Credit Cards Accepted",
